      ...
      <div className="flex flex-wrap gap-3">
        {filtered.map((asset) => (
          <a
            ...
            href={asset.url}
            download
            className="group relative inline-block rounded-full bg-gradient-to-r from-[#e84545] to-[#b33a73] p-[2px] shadow-sm transition-all duration-150 ease-out hover:shadow-md hover:brightness-110 active:scale-90"
          >
