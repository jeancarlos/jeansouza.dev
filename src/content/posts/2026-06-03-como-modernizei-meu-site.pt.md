...
Para evitar *layout thrashing* (que causa travamento ou engasgo de animações em dispositivos mais modestos), nós limitamos as atualizações usando `requestAnimationFrame`:
